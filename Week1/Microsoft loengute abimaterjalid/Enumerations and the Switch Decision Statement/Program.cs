...
namespace Enumerations_and_the_Switch_Decision_Statement
{
    class Program
    {
        ...
        private static void PrintAssessment(List<Todo> todos)
        {
            ...
            {
                //Näidatud switchi süntaks.
                switch (todo.Status)
                {
                    case Status.NotStarted:
                        //ForegroundColor muudab teksti värvust cmd's.
    ...
    class Todo
    {
        ...
        public Status Status { get; set; } //Status enum laseb public Status'sel aktsepteerida ainult eelnevalt defineeritud väärtusi.
    }
    enum Status
    {
        NotStarted,
